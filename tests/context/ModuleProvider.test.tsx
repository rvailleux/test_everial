...
describe('ModuleProvider', () => {
  ...
  it('T008: should provide initial modules', () => {
    const mod1 = createTestModule('mod-1');
    const mod2 = createTestModule('mod-2');

    render(
      <ModuleProvider initialModules={[mod1, mod2]}>
        <TestConsumer />
      </ModuleProvider>
    );
  ...
  it('T008: should track active module', async () => {
    const testModule = createTestModule('test-module');

    render(
      <ModuleProvider initialModules={[testModule]}>
        <TestConsumer />
      </ModuleProvider>
    );
